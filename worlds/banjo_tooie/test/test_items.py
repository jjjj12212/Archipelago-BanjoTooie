...
class TestBKMovesALLEnabled(BanjoTooieTestBase):
    options = {
...
class TestBKMovesMcJiggyEnabled(BanjoTooieTestBase):
    options = {
    ...
    def test_item_pool(self) -> None:
        ...
        for name, move in all_group_table["bk_moves"].items():  
            if move.btid == 1230815 or move.btid == 1230816:
...
class TestBKMovesDisabled(BanjoTooieTestBase):
    options = {
