...
jiggy_table = {
    # itemName.JIGGYIH1:  ItemData(1230676, 1, "useful", None),
    # itemName.JIGGYIH2:  ItemData(1230677, 1, "useful", None),
    # itemName.JIGGYIH3:  ItemData(1230678, 1, "useful", None),
    # itemName.JIGGYIH4:  ItemData(1230679, 1, "useful", None),
    # itemName.JIGGYIH5:  ItemData(1230680, 1, "useful", None),
    # itemName.JIGGYIH6:  ItemData(1230681, 1, "useful", None),
    # itemName.JIGGYIH7:  ItemData(1230682, 1, "useful", None),
    # itemName.JIGGYIH8:  ItemData(1230683, 1, "useful", None),
    # itemName.JIGGYIH9:  ItemData(1230684, 1, "useful", None),
